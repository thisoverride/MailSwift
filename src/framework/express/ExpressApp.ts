...
import TrackingController from '../../adapter/controller/TrackingController';
...
export default class ExpressApp {
  ...
  private _initializeIoCContainer(): void {
    ...
    this.IoCContainer.bind<TrackingController>(TrackingController).toSelf();
  }

  private _configureApp(): void {
    configureMiddleware(this.app)
    HotSpring.bind(this.app, this.IoCContainer, EmailController)
    HotSpring.bind(this.app, this.IoCContainer, TrackingController)
